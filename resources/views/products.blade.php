                        ...
                        <div class="widget-desc">
                            ...
                            <div class="single-recommended-product d-flex mb-30">
                                <div class="single-recommended-thumb mr-3">
                                    <img src="{{asset('storage/img/product-img/product-10.jpg')}}" alt="">
                                </div>
                            ...
                            <div class="single-recommended-product d-flex mb-30">
                                <div class="single-recommended-thumb mr-3">
                                    <img src="{{asset('storage/img/product-img/product-11.jpg')}}" alt="">
                                </div>
                                <div class="single-recommended-desc">
                                    <h6>Blue mini top</h6>
                                    <p>$ 19.99</p>
                            ...
                            <div class="single-recommended-product d-flex">
                                <div class="single-recommended-thumb mr-3">
                                    <img src="{{asset('storage/img/product-img/product-12.jpg')}}" alt="">
                                </div>
                                <div class="single-recommended-desc">
                        ...
                        @foreach($products as $product)
                            <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig" data-wow-delay="0.2s">
                                ...
                                <div class="product-img">
                                    <img src="{{asset('storage/img/product-img/'.$product->image)}}" alt="">
                                ...
                                <div class="product-description">
                                    ...
                                    <!-- Add to Cart -->
                                    <a href="{{route('addToCart', ['id'=>$product->id])}}" class="add-to-cart-btn">ADD TO CART</a>
                                </div>
                            </div>
                        @endforeach
