                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="cart_product_img d-flex align-items-center">
                                        <a href="#"><img src="{{Storage::url('img/product-img/' .$item['data']['image'])}}" alt="Product"></a>
                                        <h6>{{$item['data']['name']}}</h6>
                                    </td>
                                    <td class="price"><span>{{ $item['singlePrice'] }}</span></td>
                                    <td class="qty">
                                        <div class="quantity">
                                    ...
                                    <td class="total_price"><span>{{$item['totalSinglePrice']}}</span></td>
                                    <td class="total_price"><a href="{{route('deleteCartItem', ['id' => $item['data']['id']])}}"><i class="fas fa-window-close"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="col-12 col-lg-4">
                    <div class="cart-total-area mt-70">
                        ...
                        <ul class="cart-total-chart">
                            <li><span>Subtotal</span> <span>{{ $cartItems->totalPrice}}</span></li>
                            @if(session()->get('coupon'))
                                <li>
                                    <span>
                                        Discount
                                        ...
                                        @csrf
                                        @method('delete')
                                        <button type="submit" class="btn btn-link" style="font-size: 14px">Remove</button>
                                        </form>
                                    </span> 
